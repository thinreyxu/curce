...
(function (exports) {
  exports.querySelectorAll = window.querySelectorAll || query;
  ...
  // Test tokenizeSequenceOfSelectors() function
  // console.log(JSON.stringify(tokenizeSequenceOfSelectors('div#div-id.div2[attr][attr~="name"]:first-child:not(.div1):nth-of-type(2n+1)'), null, '  '));
  // console.log(JSON.stringify(tokenizeSequenceOfSelectors('div#div-id.div2[attr][attr~="name"]:first-child:not(:not(.div1)):nth-of-type(2n+1)'), null, '  '));

  // Test tokenizeFirstSimpleSelector() function;
  // console.log(tokenizeFirstSimpleSelector('#div-id.div2'));
  // console.log(tokenizeFirstSimpleSelector('.div-class.div2'));
  // console.log(tokenizeFirstSimpleSelector('div.div2'));
  // console.log(tokenizeFirstSimpleSelector('*.div2'));
  // console.log(tokenizeFirstSimpleSelector('[attr].div2'));
  // console.log(tokenizeFirstSimpleSelector('[attr=name].div2'));
  // console.log(tokenizeFirstSimpleSelector('[attr~="name"].div2'));
  // console.log(tokenizeFirstSimpleSelector(':first-child.div2'));
  // console.log(tokenizeFirstSimpleSelector(':not(.div1).div2'));
  // console.log(tokenizeFirstSimpleSelector(':nth-of-type(2n+1).div2'));
